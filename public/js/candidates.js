...
const candidate3PoliticalOpinions = [
    '1. 校內 Youbike 收費調整：新竹內的共享單車收費方式即一經租借，開始計費，若在校內完成租借與歸還的動作，意即不長占腳踏車的狀況下，還要收費的話，我認為此舉將大大降低學生使用的意願。因此我認為，可以效法中彰地區的前三十分鐘免費方案，免費時段可議。藉此，不但讓學生更方便，也讓學生不會有虧錢之感。',
    '2. 自用腳踏車架維護：停腳踏車時，尖峰時刻，如中午時段，當腳踏車一多，空位常剩下毀損的腳踏車架，造成使用者無法順利停入，於是任意擺放，阻礙交通。我認為應和學校溝通與叮嚀，定期維護並更換毀損的車架，以方便使用者停放。',

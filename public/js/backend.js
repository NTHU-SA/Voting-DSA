...
function detailFormatter(index, row) {
    ...
    if (resp) {
        ...
        var candidatesIdMapping = {};
        var result = getVotes(row._id, candidates);
        var voteStatics = result.statics;
        votes = result.votes;
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="verificationTitle-${id}">Modal title</h5>
